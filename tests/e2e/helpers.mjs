...
export function fixtureDb(){
  ...
  return{local_products:products,orders,order_store_segments,store_categories:categories,vendor_operating_expenses:[],settings};
}
