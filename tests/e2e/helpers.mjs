...
export function fixtureDb(){
  ...
  const order_store_segments=[{segment_id:'seg-e2e-1',order_id:'global-e2e-1',order_code:'KN-009501',reference_order_no:'SIP-9501',order_created_at:new Date().toISOString(),items_preview:[{product_id:'p-1',product_name:'Segment Product',product_image:'',quantity:2,unit_price_local:8000,line_total_local:16000,currency:'IQD'}],quantity_total:2,subtotal_local:16000,currency:'IQD',store_status:'بانتظار التسديد',confirmed_at:new Date().toISOString(),vendor_payment_status:'pending',customer:{name:'عميل الاختبار',code:'CUS-9501',phone:'07700000000',secondary_phone:'07800000000',country:'العراق',province:'بغداد',address:'الكرادة، شارع الاختبار'}}];
