...
.local-v3-name{font-size:1.1rem!important;font-weight:900!important;color:#ffffff!important;margin-bottom:6px!important}.local-v3-desc{font-size:.95rem!important;color:#ffffff!important;font-weight:500!important;line-height:1.5!important;min-height:22px!important;margin-top:4px!important}
...
function renderCards(grid,store,products,{fromCache=false}={}){
  const cards=(products||[]).map(p=>{
    ...
    const old=hasDiscount&&oldIqd!==null?`<div class="local-v3-old-row"><del class="local-v3-old" style="text-decoration:line-through !important;color:#94a3b8;font-size:.85rem;"><span class="local-v3-money" dir="ltr">${esc(iqdLabel(oldIqd))}</span></del></div>`:'';
