...
function loadCountryRegistration(){if(document.querySelector('script[data-kinto-country-registration]'))return;const script=document.createElement('script');script.src='js/kinto-registration-country-phone-v163.js?v=20260915-v164';script.defer=true;script.dataset.kintoCountryRegistration='true';document.head.appendChild(script)}
loadCountryRegistration();
