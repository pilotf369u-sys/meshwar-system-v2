(function(global){
  ...
  function save(token,expiresAt){sessionStorage.setItem(STORAGE_KEY,JSON.stringify({token:String(token),expiresAt:expiresAt||new Date(Date.now()+30*86400000).toISOString()}))}
