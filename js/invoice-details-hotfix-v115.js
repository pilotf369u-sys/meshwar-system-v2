...
if(/(?:^|\/)(?:employee|admin)-dashboard\.html$/.test(location.pathname)){
  ...
  .kinto-staff-order-details .kinto-customer-style-details{direction:rtl;color:#f7fbf8;background:#07513f;border:1px solid rgba(215,166,46,.32);border-radius:16px;padding:14px 16px;box-shadow:inset 0 1px 0 rgba(255,255,255,.06);display:grid;grid-template-columns:repeat(2,minmax(0,1fr));column-gap:24px;align-items:start}
  .kinto-staff-order-details .kinto-customer-style-details p{margin:0;padding:5px 2px;color:#f7fbf8!important;line-height:1.55;font-size:13px;min-width:0;overflow-wrap:anywhere}
  .kinto-staff-order-details .kinto-customer-style-details b{color:#fff!important;font-weight:900}.kinto-staff-order-details .kinto-customer-style-details hr{grid-column:1/-1;width:100%;border:0;border-top:1px solid rgba(255,255,255,.45);margin:6px 0}.kinto-staff-order-details .kinto-customer-style-details a{color:#72b7ff!important;font-weight:900}
  ...
  @media(max-width:700px){#orderDetailsModal .modal-content{width:96vw!important;margin:2vh auto!important;padding:14px!important;border-radius:17px!important}.kinto-staff-order-details .kinto-customer-style-details{grid-template-columns:1fr;column-gap:0}.kinto-staff-order-details .detail-grid{grid-template-columns:1fr!important}.kinto-staff-order-brand{padding:10px 12px}.kinto-staff-order-mark{width:38px;height:38px}.kinto-staff-order-brand b{font-size:18px}}
  `;
