...
const decorateStaffDetails=box=>{
  ...
  box.insertAdjacentHTML('afterbegin','<div class="kinto-staff-order-brand"><span class="kinto-staff-order-mark">K</span><div><b>KINTO</b><small>تفاصيل الطلب</small></div></div>');
};
...
if(/(?:^|\/)(?:employee|admin)-dashboard\.html$/.test(location.pathname)){
  ...
  .kinto-staff-order-mark{width:42px;height:42px;display:grid;place-items:center;border-radius:50%;background:rgba(255,255,255,.08);border:1px solid rgba(215,166,46,.72);color:#e5bd55;font-size:24px;font-weight:950}
  ...
  .kinto-staff-order-details .kinto-v94-item{background:rgba(255,255,255,.72);border-radius:13px!important}
