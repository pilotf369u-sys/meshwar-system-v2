...
assert.match(dashboard,/<html lang="ar" dir="rtl" class="admin-auth-pending">/);
assert.match(dashboard,/html\.admin-auth-pending body\{visibility:hidden\}/);
assert.match(helper,/classList\.remove\(['"]admin-auth-pending['"]\)/);
