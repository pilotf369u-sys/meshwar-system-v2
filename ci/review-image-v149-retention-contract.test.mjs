...
assert.match(js,/const MAX_IMAGES = 1/);assert.match(js,/canvas\.toBlob/);assert.match(js,/state\.files = \[await compressReviewImage\(file\)\]/);assert.doesNotMatch(js,/MAX_FILE_BYTES = 5 \* 1024 \* 1024/);
