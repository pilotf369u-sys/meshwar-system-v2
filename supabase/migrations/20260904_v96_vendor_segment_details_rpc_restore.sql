-- V96 restore the vendor segment-details RPC and refresh PostgREST schema cache.
...
begin
  ...
  if coalesce(v_order ->> 'customer_id', '')
...
grant execute on function public.vendor_get_order_segment_details(text, uuid)
