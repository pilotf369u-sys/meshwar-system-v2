...
old='<div class="vendor-table-wrap"><table class="vendor-responsive-table text-sm"><colgroup><col style="width:16%"><col style="width:18%"><col style="width:8%"><col style="width:10%"><col style="width:17%"><col style="width:13%"><col style="width:18%"></colgroup><thead class="border-b border-white/10 text-slate-400"><tr><th>رقم الطلب</th><th>المنتج</th><th>الكمية</th><th>عدد الطرود</th><th>المحافظة / المدينة</th><th>الحالة</th><th>الإجراء</th></tr></thead><tbody id="ordersBody"></tbody></table></div>'
new='<div class="vendor-table-wrap"><table class="vendor-responsive-table text-sm"><colgroup><col style="width:9%"><col style="width:14%"><col style="width:16%"><col style="width:7%"><col style="width:8%"><col style="width:14%"><col style="width:11%"><col style="width:10%"><col style="width:11%"></colgroup><thead class="border-b border-white/10 text-slate-400"><tr><th>الصورة</th><th>رقم الطلب</th><th>المنتج</th><th>الكمية</th><th>عدد الطرود</th><th>المحافظة / المدينة</th><th>الحالة</th><th>رابط المنتج</th><th>الإجراء</th></tr></thead><tbody id="ordersBody"></tbody></table></div>'
if old not in s: raise SystemExit('orders table header signature missing')
...
# Preserve existing order query; details already contains product_id/product_image for current storefront orders.
